...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('check-inactif-v1')
        .setDescription("Envoie un message de vérification d'inactivité (1 Embed Bilingue).")
    ...
    async execute(interaction) {
        ...
        const embed = new EmbedBuilder()
            .setColor('#2F3136')
            .setTitle('Gowrax - Mise au point / Update')
...
A few days ago, some of you received a message regarding your willingness to continue this journey with us.
